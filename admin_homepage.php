...
<body class="bg-gray-100">
  ...
  <main class="container mx-auto mt-10 ml-5">
    ...
    <section class="mt-10">
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white shadow rounded-lg p-4 text-center mx-2 my-4">
                <img src="img/tari.jpg" alt="Tari" class="h-24 mx-auto">
                <h3 class="mt-4 font-semibold">Tari</h3>
                <!-- Masuk button -->
                <button class="masuk-button mt-2 inline-block bg-red-500 text-white px-4 py-2 rounded" data-ukm="Tari">Masuk</button>
            </div>
    ...
    <!-- Enrollment Key Popup -->
    <div id="enrollmentKeyModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <h2 class="text-lg font-semibold mb-4">Masukkan Enrollment Key</h2>
            <input type="password" id="enrollmentKeyInput" class="border p-2 w-full mb-4" placeholder="Enrollment Key">
            <button id="submitEnrollmentKey" class="bg-blue-500 text-white px-4 py-2 rounded">Submit</button>
        </div>
    </div>
    ...
    submitButton.addEventListener('click', () => {
        ...
        if (key) {
            ...
            .catch(error => {
                ...
                alert('An error occurred while validating the enrollment key.');
            });
        } else {
